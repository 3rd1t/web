...
import { RangePicker } from "@perfolio/components/rangepicker";
...
for (let i = 1; i < points.length; i++) {
  points[i] =
    points[i - 1] * (1 + 0.07) + (points[i - 1] * (Math.random() - 0.5)) / 2;
}
...
const AreaChart = () => {
  ...
  const options = {
    ...
    fill: {
      type: "gradient",
      gradient: {
        gradientToColors: ["#312E81","#6B21A8"], // optional, if not defined - uses the shades of same color in series
        opacityFrom: 0.8,
        opacityTo: 0.4,
      }
    }
            ...
            <div className="flex items-center justify-between divide-x divide-gray-300">
              <div className="pr-8">
                <div className="flex items-center justify-between">
                  ...
                  <span className="px-2 rounded-full text-emerald-800 bg-emerald-100">
                    +7.4% p.a.
                  </span>
                </div>
              ...
              <div className="pl-8">
                <div className="flex items-center justify-between">
                  ...
                  <span className="px-2 text-red-800 bg-red-100 rounded-full">
                    -0.2%
                  </span>
                </div>
                <div className="text-4xl font-semibold tracking-wide">
