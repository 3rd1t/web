  ...
  return (
    ...
    <Section className="mx-auto prose-sm prose sm:prose lg:prose-lg xl:prose-xl">
      ...
      <p>
        ...
        ist, werden Vertragspartner hierauf ebenso hingewiesen wie auf die für
        ...
        Rahmen der Registrierung sowie anschließender Anmeldungen und Nutzungen
      ...
      <ul>
        <li>
          ...
          Dienstanbieter: "Mailchimp" - Rocket Science Group, LLC, 675 Ponce De
          Leon Ave NE #5000, Atlanta, GA 30308, USA; Website:{" "}
      ...
      <p>
        <strong>Hinweise zu Rechtsgrundlagen:</strong> Sofern wir die Teilnehmer
        um eine Einwilligung in die Verarbeitung iherer Daten bitten, ist diese
      ...
      <ul>
        ...
        <li>
          ...
          Tracking (z.B. interessens-/verhaltensbezogenes Profiling, Nutzung von
          Cookies), Feedback (z.B. Sammeln von Feedback via Online-Formular).
        </li>
        <li>
          <strong>Rechtsgrundlagen:</strong> Einwilligung (Art. 6 Abs. 1 S. 1
          lit. a DSGVO), Berechtigte Interessen (Art. 6 Abs. 1 S. 1 lit. f.
