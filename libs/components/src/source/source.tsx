...
export const Source = ({
  ...
  const buttonStyle =
    "text-xs text-gray-900 focus:outline-none hover:text-data-600";
      ...
      <div className="flex flex-wrap py-8 md:flex-no-wrap">
        ...
        <div className="space-y-4 md:flex-grow">
          ...
          <div className="flex items-center space-x-4">
            ...
            <button
              onClick={() => setCitationOpen(!isCitationOpen)}
        ...
        {isCitationOpen && (
          <AnimateSharedLayout>
            ...
            >
              ...
              <button
                onClick={copy}
                className="relative h-full px-6 text-gray-800 focus:outline-none "
              >
                {copied ? (
                  <motion.svg
