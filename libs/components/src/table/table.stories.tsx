...
export const singleRow = () => {
  ...
  const rows = [
    <tr>
      <Simple label="Andreas Thomas" />,
      <Tag label={123456789} color="purple" />, <Simple label="22.09.2020" />
    </tr>,
  ];
...
export const multipleRows = () => {
  ...
  const rows = [
    ...
    <tr>
      <Simple label="Mads Jordt" />, <Simple label={123456789} />,
      <Simple label="22.09.2020" />
    </tr>,
    <tr>
      <Simple label="Kevin Kohler" />, <Simple label={123456789} />,
      <Simple label="22.09.2020" />
    </tr>,
  ];
...
export const previewMode = () => {
  ...
  return <Table columnNames={columnNames} rows={[]} />;
};
