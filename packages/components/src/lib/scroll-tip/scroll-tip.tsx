...
export const ScrollTip = (props: ScrollTipProps) => {
  return (
    ...
    >
      <div 
       className={"inline-flex w-10 h-10 p-2 transform rotate-45 shadow-xl lg:p-4 md:h-12 md:w-12 lg:h-16 lg:w-16 hover:scale-110 ease-in-out duration-200" + " " + props.className}>
