...
export const Footer = () => {
  return (
    <footer className="flex flex-col items-center justify-center p-12 space-y-8 text-gray-400 bg-gray-900">
      <div className="text-gray-100">
        <Logo></Logo>
      </div>
      <div className="flex items-center justify-between space-x-16 uppercasetext-lg">
