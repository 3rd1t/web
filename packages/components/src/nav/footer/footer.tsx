...
const footerLink = (label: React.ReactNode | string, href: string): React.ReactNode => {
  return (
    <Link href={href}>
...
export const Footer = () => {
  return (
    <footer className="flex flex-col items-center justify-center p-12 space-y-8 bg-gray-900">
      <div className="text-gray-100">
        <Logo></Logo>
      </div>
      <div className="flex items-center justify-between space-x-16 text-gray-200 uppercasetext-lg">
      ...
      <div className="flex items-center justify-between w-full text-sm text-gray-200">
        <div className="flex items-center justify-start w-1/3">
          <span>© Copyright {new Date().getFullYear()}. All Rights Reserved.</span>
        </div>
        <div className="flex items-center justify-center w-1/3 space-x-4 text-gray-200">
          {footerLink("Roadmap", "https://perfol.io/roadmap")}
          {footerLink("Imprint", "/imprint")}
          {footerLink("Privacy", "/privacy")}
        </div>
        <div className="flex items-center justify-end w-1/3 space-x-8 text-gray-200">
          {footerLink(
