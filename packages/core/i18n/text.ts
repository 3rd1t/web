...
export const translations: Translations = {
  ...
  independentDescription: {
    ...
    de: "Wir agieren komplett unabhängig von finanziellen Institutionen. Von uns bekommst Du einen unvoreingenommenen Blick auf Dein Portfolio - ohne Dir etwas verkaufen zu wollen.",
  },
  complexMadeEasy: {
  ...
  complexMadeEasyDescription: {
    ...
    de: "Jeder sollte Zugang zu den neuesten Analysemethoden aus der Wissenschaft haben. Diese Methoden so einfach und verständlich wie möglich darzustellen, gehört zu unserem Kerngeschäft.",
  },
  allInOnePlace: {
    en: "All in one place",
  ...
  allInOnePlaceDescription: {
    ...
    de: "Keine Lust mehr, diverse Websites und Apps zu besuchen, um Dir einen Überblick über Dein Vermögen zu verschaffen? Perfolio ist das neue Zuhause für Deine Daten.",
  },
  highestDataQuality: {
  ...
  highestDataQualityDescription: {
    ...
    de: "Wir bereinigen und analysieren Daten nach den höchsten Standards. Mit unserem Premiumplan erhälst Du Zugang zu einer noch besseren Datenqualität.",
  },
  privacyAndSecurity: {
  ...
  privacyAndSecurityDescription: {
    ...
    de: "Wir geben Deine Daten niemals weiter und speichern sie nur auf Servern innerhalb der EU. Datenschutz und Sicherheit haben für uns höchste Priorität.",
  },
  fairPricing: {
    en: "Fair pricing",
    de: "Faire Preise",
  ...
  fairPricingDescription: {
    ...
    de: "Starte gratis! Wenn Du mehr willst, hol Dir den Plan, der am besten zu Dir passt. Keine versteckten Gebühren.",
  },
  ourTeam: {
    en: "Our Team",
    de: "Unser Team",
  ...
  perfolioDescription1: {
    ...
    de: "Wir, bei Perfolio, sind der Meinung, dass Investitionsentscheidungen immer auf möglichst vielen fundierten Informationen beruhen sollten. Es ist unsere Mission, unseren Benutzern die relevantesten und genauesten Finanzinformationen zur Verfügung zu stellen.",
  },
