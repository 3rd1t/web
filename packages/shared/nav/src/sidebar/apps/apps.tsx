...
export const Apps = (props: AppsProps) => {
  return (
    <div className="flex flex-col items-center justify-between w-24 py-4 bg-white">
      <div className="flex flex-col items-center space-y-12">
        <svg
          className="w-12 text-gray-900 stroke-current"
          viewBox="0 0 194 148"
          fill="none"
        ...
        <ul className="w-full text-gray-500">
          <li key="Factor Returns">
            <App active label="Factor Returns">
